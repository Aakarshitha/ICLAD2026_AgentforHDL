...
module secure_periph_soc (
    ...
    // Reset
    wire sys_rst_n;
    wire wdt_rst_req_int;
    assign wdt_rst_req = wdt_rst_req_int;
    
    // AHB to APB Bridge -> APB Fabric
    wire        apb_psel;
    wire        apb_penable;
    wire        apb_pwrite;
    wire [31:0] apb_paddr;
    ...
    assign irq_src = {4'b0000, wdt_irq, timer_irq, gpio_irq, uart_irq};
